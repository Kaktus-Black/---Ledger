...
function pageDashboard() {
  ...
  return `
    ...
    <div class="quick-actions">
      <button class="btn btn-primary" data-action="goto" data-hash="add">+ Add income</button>
      <button class="btn btn-outline" data-action="goto" data-hash="add">+ Add expense</button>
      <button class="btn btn-ghost" data-action="goto" data-hash="add">⇄ Transfer</button>
    </div>
...
function pageSettings() {
  ...
  return `
    ...
    <div class="ledger-form" style="max-width:420px">
      ...
      <label>Theme<select data-action="set-theme"><option value="light" ${state.settings.theme === "light" ? "selected" : ""}>Light (ledger paper)</option><option value="dark" ${state.settings.theme === "dark" ? "selected" : ""}>Dark (ink) — coming soon</option></select></label>
